...
export async function fetchWorkoutExerciseSets(idWorkoutExercise) {
  try {
    const token = await getToken();
    ...
    const response = await fetch(
      `${API_BASE}/workoutExerciseSets/${idWorkoutExercise}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function createWorkoutExerciseSets(request) {
  try {
    const token = await getToken();
    ...
    const response = await fetch(`${API_BASE}/createWorkoutExerciseSet`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
